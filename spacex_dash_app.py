...
site_dropdown = dcc.Dropdown(
    ...
    value='ALL'  # Default value for all sites
)

# TASK 3: Add a slider to select payload range
# Define the min and max payload values
min_payload = spacex_df['Payload Mass (kg)'].min()
max_payload = spacex_df['Payload Mass (kg)'].max()

# Create the payload slider component
payload_slider = dcc.RangeSlider(
    ...
    value=[min_payload, max_payload]  # Default value for the full payload range
)

# Now, add these components to your layout
app.layout = html.Div(children=[
    ...
    # TASK 3: Add the payload slider component
    payload_slider,
    html.Br(),
